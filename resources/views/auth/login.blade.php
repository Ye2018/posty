        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" id="password" placeholder="Input your password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password') border-red-500 @enderror" value="">
